...
public var _Vida:Float;

 
 	public function new(dummy:Int, actor:Actor, dummy2:Engine)
	{
		super(actor);
		nameMap.set("Vida", "_Vida");
_Vida = 10.0;
...
if(wrapper.enabled)
{
        createRecycledActor(getActorType(62), (actor.getX() + 33), actor.getY(), Script.FRONT);
        getLastCreatedActor().applyImpulseInDirection(230, 40);
        createRecycledActor(getActorType(62), (actor.getX() + 33), actor.getY(), Script.FRONT);
        getLastCreatedActor().applyImpulseInDirection(310, 40);
}
}, actor);
