...
/* =========================== Keyboard =========================== */
addKeyStateListener("espacio", function(pressed:Bool, released:Bool, list:Array<Dynamic>):Void
{
...
{
            if((isKeyPressed("Lanzar") && (Engine.engine.getGameAttribute("posicionjugador") == 0)))
{
            ...
            if((isKeyPressed("Lanzar") && (Engine.engine.getGameAttribute("posicionjugador") == 1)))
{
