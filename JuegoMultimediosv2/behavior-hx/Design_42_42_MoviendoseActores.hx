...
class Design_42_42_MoviendoseActores extends ActorScript
{          	
	
public var _PosicionInicia:Float;
...
public var _PosicionInicial:Float;
	...
	{
		super(actor);
		nameMap.set("PosicionInicia", "_PosicionInicia");
_PosicionInicia = 0;
...
if(wrapper.enabled)
{
        if((actor.getX() < _PosicionInicial))
{
