...
/* ======================== When Creating ========================= */
        Engine.engine.setGameAttribute("PuntageGlobal", (Engine.engine.getGameAttribute("PuntageGlobal") + (Engine.engine.getGameAttribute("PuntajeEscena") + Engine.engine.getGameAttribute("puntosExtra"))));
